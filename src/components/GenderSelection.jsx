...
const GenderSelection = ({ onSelect }) => {
    return (
        <div className="w-full max-w-md text-center">
            <div className="mb-8">
                <img className="w-24 h-24 mx-auto" src='gender.png' />
            </div>
            <h2 className="text-2xl font-bold mb-6">Qual é a sua identidade de gênero?</h2>
            <p className="mt-4 text-sm text-gray-400">
                <span className="cursor-pointer hover:text-teal-400">Por que perguntamos isso?</span>
            </p>
